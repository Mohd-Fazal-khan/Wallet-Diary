...
const Signup = () => {
  ...
  return (
    <NetworkProvider>
      ...
      <KeyboardAvoidingView
        behavior={Platform.OS === "ios" ? "padding" : "height"}
        style={{ flex: 1, backgroundColor: "#ffffff" }} // ✅ ensures no black flicker
        keyboardVerticalOffset={Platform.OS === "ios" ? 0 : 20}
      >
        <ScrollView
          contentContainerStyle={{ flexGrow: 1, backgroundColor: "#ffffff" }} // ✅ consistent bg
          keyboardShouldPersistTaps="handled"
        >
          <View style={styles.container}>
            <Image
              style={styles.logo}
              source={require("../assets/images/logo.png")}
              fadeDuration={0} // ✅ prevents fade flicker on Android
            />
